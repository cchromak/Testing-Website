...
<body>
  ...
  <!-- This div holds the message that we will display on the page -->
  <div class="container">
      <h1 index="greeting" class="display-1">Let's sign you up!</h1>
  </div>

  <!-- This div is empty unless we get an error, it is here to add any errors from registration.php -->
  <div class ="container">
    <?php
    if (isset($_GET['error']))
    {
      ...
      if($_GET['error'] == 'username'){
        $message = "The username you entered is already registered!";
      ...
      //incorrect password
      else if($_GET['error'] == 'emailUser'){
        $message = "The email you entered is already registered with this type of account!";
        echo '<span class="error">';
        echo "$message";
        echo '</span>';
      }
  ...
  <!-- This div holds the form for registering -->
  <div>
