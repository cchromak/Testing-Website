...
<?php
  if(!isset($_SESSION['username'])){
    ...
    if($type[0] == "P"){
      Header("Location: ../professor/contactus.php");
      mysqli_close($db);
      die();
    }
    mysqli_close($db);
...
<body>
  ...
  <!-- This holds the message on our page -->
  <div class="container">
    <h1 index="greeting" class="display-1">Send us an Email!</h1>
  </div>

  <!-- This holds the form to send an email -->
  <main>
    <form class="contact-form" action="contact.php" method="post">
      ...
      <div class="form-group"></div>
        <textarea name="message" class="form-control" placeholder="What do you want to tell us?"></textarea>
      </div>
      <div class="container">
      	<br>
  ...
  <div class="container">
    <br><br>
    <a class="twitter-timeline" data-width="600" data-height="400" data-theme="light" href="https://twitter.com/EpicsauceT?ref_src=twsrc%5Etfw">Tweets by EpicsauceT</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
</div>
