...
<?php
  if(!isset($_SESSION['username'])){
    ...
    if($type[0] == "P"){
      Header("Location: ../professor/help.php");
      mysqli_close($db);
      die();
    }
    mysqli_close($db);
...
<body>
    ...
    <div class="container">
    <h1 index="greeting" class="display-2">Video Tutorial</h1>
    <br>
    <iframe style="border: 6px solid #000000;" width="853" height="480" src="https://www.youtube.com/embed/n4QO8KinRKA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
  
  
   <div class="container">
    <br>
    <h1 index="ending" class="display-2">Frequently Asked Questions</h1>
    <p class="lead">
